...
from src.models import CNN, MultiResNet, DenseNet, trace_loss, trace_MSE, intensity_loss, intensity_MSE, train_combined_loss_training_intensity
...
if __name__ == "__main__":
    ...
    config = {
        'start_with': 0,  # 0 : Start with the intensity loss, 1 : Start with the trace loss
        'trace_epochs': 25,
        'intensity_epochs': 10,
    ...
    train_combined_loss_training_intensity(train_dataset,
                                 test_dataset,
                                 model,
                                 optimizer,
                                 trace_loss_fn,
    ...
    # model.save(
    #     f"./trained_models/CNN/{config['arquitecture']}_test_N{N}_normTraces_combinedTraining_intensity.tf")
